...
$boleto = new Adautopro\LaravelBoleto\Boleto\Banco\Itau([
    ...
    'qr_code_style'          => Adautopro\LaravelBoleto\Boleto\Banco\Itau::QRCODE_ESTILO_PONTO,
]);

$pdf = new Adautopro\LaravelBoleto\Boleto\Render\Pdf();
$pdf->addBoleto($boleto);
$pdf->setLocalizacaoPix(Adautopro\LaravelBoleto\Boleto\Render\Pdf::PIX_INSTRUCAO);
//$pdf->setLocalizacaoPix(Adautopro\LaravelBoleto\Boleto\Render\Pdf::PIX_COD_BARRAS);
