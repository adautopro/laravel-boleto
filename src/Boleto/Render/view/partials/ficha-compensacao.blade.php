<table class="table-boleto" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td colspan="{{ isset($pix_qrcode) && $localizacao_pix == \Adautopro\LaravelBoleto\Boleto\Render\Html::PIX_INSTRUCAO ? 6 : 7 }}">
            <div class="titulo">Instruções de responsabilidade do beneficiário. Qualquer dúvida sobre este boleto,
                contate o beneficiário
            </div>
        </td>
        @if(isset($pix_qrcode) && $localizacao_pix == \Adautopro\LaravelBoleto\Boleto\Render\Html::PIX_INSTRUCAO)
    ...
    <tr>
        <td colspan="{{ isset($pix_qrcode) && $localizacao_pix == \Adautopro\LaravelBoleto\Boleto\Render\Html::PIX_INSTRUCAO ? 6 : 7 }}" class="notopborder">
    ...
    <tr>
        <td colspan="8" class="noborder">
            {!! $codigo_barras !!}
            @if(isset($pix_qrcode) && $localizacao_pix == \Adautopro\LaravelBoleto\Boleto\Render\Html::PIX_COD_BARRAS)
